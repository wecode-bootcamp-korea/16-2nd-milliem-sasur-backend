...
book_df = pd.DataFrame(columns=('title','link', 'image', 'author', 'price', 'discount', 'publisher', 'isbn', 'description', 'pubdate'))
...
for start_index in range(start, end, display):
    ...
    if(rescode==200):
        ...
        for item_index in range(0,len(items)):
            ...
            purchase_url = items[item_index]['link']
...
# book_df.to_json("일반소설.json", encoding='utf-8-sig') csv 파일 저장시키기
book_df